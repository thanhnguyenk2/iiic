...
%%
z_o = [z1_1;z2_1];            %% them bias vao z out
%% Lop ra
neto1_1 = w_1'*z_o;
...
xichmaH1_1 = xichmaO_1*w_1(1)*round(double(subs(f_an_diff,z1_1)),3); %tansig dao ham
xichmaH2_1 = xichmaO_1*w_1(2)*round(double(subs(f_an_diff,z2_1)),3);
