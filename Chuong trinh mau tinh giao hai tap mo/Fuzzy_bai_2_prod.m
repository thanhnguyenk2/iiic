...
%1
y1 = Implication_PROD(beta(1), muyy_VS);
result = Or_MAX(result, y1);


y2 = Implication_PROD(beta(2), muyy_S);
result = Or_MAX(result, y2);


y3 = Implication_PROD(beta(3), muyy_ME);
result = Or_MAX(result, y3);

%4
y4 = Implication_PROD(beta(4), muyy_S);
result = Or_MAX(result, y4);


y5 = Implication_PROD(beta(5), muyy_S);
result = Or_MAX(result, y5);


y6 = Implication_PROD(beta(6), muyy_ME);
result = Or_MAX(result, y6);

%7
y7 = Implication_PROD(beta(7), muyy_S);
result = Or_MAX(result, y7);


y8 = Implication_PROD(beta(8), muyy_ME);
result = Or_MAX(result, y8);


y9 = Implication_PROD(beta(9), muyy_L);
result = Or_MAX(result, y9);

%10
y10 = Implication_PROD(beta(10), muyy_S);
result = Or_MAX(result, y10);


y11 = Implication_PROD(beta(11), muyy_S);
result = Or_MAX(result, y11);


y12 = Implication_PROD(beta(12), muyy_ME);
result = Or_MAX(result, y12);
j = j + 1;
%13
y13 = Implication_PROD(beta(13), muyy_S);
result = Or_MAX(result, y13);


y14 = Implication_PROD(beta(14), muyy_ME);
result = Or_MAX(result, y14);


y15 = Implication_PROD(beta(15), muyy_ME);
result = Or_MAX(result, y15);

%16
y16 = Implication_PROD(beta(16), muyy_S);
result = Or_MAX(result, y16);


y17 = Implication_PROD(beta(17), muyy_ME);
result = Or_MAX(result, y17);


y18 = Implication_PROD(beta(18), muyy_L);
result = Or_MAX(result, y18);

%19
y19 = Implication_PROD(beta(19), muyy_ME);
result = Or_MAX(result, y19);


y20 = Implication_PROD(beta(20), muyy_ME);
result = Or_MAX(result, y20);


y21 = Implication_PROD(beta(21), muyy_L);
result = Or_MAX(result, y21);

%22
y22 = Implication_PROD(beta(22), muyy_ME);
result = Or_MAX(result, y22);


y23 = Implication_PROD(beta(23), muyy_L);
result = Or_MAX(result, y23);


y24 = Implication_PROD(beta(24), muyy_VL);
result = Or_MAX(result, y24);

%25
y25 = Implication_PROD(beta(25), muyy_ME);
result = Or_MAX(result, y25);


y26 = Implication_PROD(beta(26), muyy_VL);
result = Or_MAX(result, y26);


y27 = Implication_PROD(beta(27), muyy_VL);
